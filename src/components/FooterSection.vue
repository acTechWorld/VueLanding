<template>
  <div class="footerSection">
    <div v-if="hasTopSection" class="footerSection_first" :style="topSectionStyle">
      <div
        :style="styleInnerWidth"
        class="flex flex-col md:flex-row gap-[50px] md:gap-10 py-10 px-5 border-b text-left mx-auto"
      >
        <div
        ...
        >
          <div v-if="hasCompanyInfos" class="footerSection_companyInfos flex gap-2">
            <img
              v-if="props.topSection?.companyLogo"
              class="footerSection_companyLogos h-8"
        ...
        >
          ...
          >
            ...
            <div
              ...
              @click="handleClickPage(category, page.name)"
            >
              {{ page.label }}
            </div>
          </div>
    ...
    <div v-if="hasBottomSection" class="footerSection_second" :style="bottomSectionStyle">
      <div
        class="py-10 px-5 flex flex-col-reverse sm:flex-row justify-between gap-5 mx-auto"
        :style="styleInnerWidth"
      >
...
const styleInnerWidth = computed(() =>
  props.innerWidth ? { maxWidth: `${props.innerWidth}px` } : {}
)
...
const handleClickPage = (category: string, pageName: string) => {
  emits('clickPage', { category: category, page: pageName })
}
</script>
