<template>
  <SwiperComponent :animation-type="props.animationType" :infinite="props.infinite">
    <div
    ...
    >
      <div v-if="data.testimony" class="text-4xl font-semibold">{{ data.testimony }}</div>
      <div
      ...
      >
        ...
        />
        <p v-if="data.name" class="text-lg font-semibold">{{ data.name }}</p>
